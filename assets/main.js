/* Grain global animé sur toute la page */
(function () {
...
/* Blobs XR — no-op si #xr-section n'existe pas sur la page */
(function () {
...
/* Blobs Electro — no-op si #el-section n'existe pas sur la page */
(function () {
...
blobStyle.textContent = `@keyframes blobFloat{
  from{transform:translate(0,0) scale(1)}
  to{transform:translate(30px,20px) scale(1.08)}
}`;
document.head.appendChild(blobStyle);

/* Fade-in au scroll pour les timeline items */
...
/* SplitText animation pour les questions d'accroche */
...
/* Ré-appliquer le splitText après changement de langue (applyLang vient de assets/i18n.js, déjà chargé) */
